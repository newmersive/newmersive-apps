...
router.get(
  ...
  (req: Request, res: Response): void => {
    try {
      ...
      const result = scanDemoProduct(ean);
      res.json(result);
    } catch (err) {
...
router.get(
  ...
  (req: Request, res: Response): void => {
    try {
      const offers = listAllwainOffers();
...
router.post(
  ...
  (req: Request, res: Response): void => {
    try {
      ...
      const group = createOrderGroup(productId, minUnitsPerClient);
...
router.post(
  ...
  (req: Request, res: Response): void => {
    try {
      ...
      const group = joinOrderGroup(groupId, userId, units);
      res.json(group);
    } catch (err: any) {
...
router.post(
  ...
  (req: Request, res: Response): void => {
    try {
      ...
      const result = registerSaving(userId, amount);
...
router.get(
  ...
  (req: Request, res: Response): void => {
    try {
      ...
      const summary = getSponsorSummary(userId);
      res.json(summary);
    } catch (err) {
